    ...
    function init(arr, columnConfig) {
        ...
        arr.forEach(function(itemData, itemDataI) {
            ...
            columnConfig.forEach(function(columnConfigItemData, columnConfigItemDataI) {
                ...
                var val = columnConfigItemData.value !== undefined ? columnConfigItemData.value : itemData[columnConfigItemData.key];
                var textVal = '' + (columnConfigItemData.getValue ? columnConfigItemData.getValue(val, itemData) : (val !== undefined ? val : '')) || '';

                if (columnConfigItemData.icon) {
                    item = new QTableWidgetItem(new QIcon(columnConfigItemData.icon), textVal, 0);
                } else {
                    item = new QTableWidgetItem(textVal, 0);
                }
