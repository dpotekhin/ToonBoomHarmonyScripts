...
function PS_CreateDrawingNode() {
    ...
    */
    ...
    Tools.createDrawing();
    column.renameDrawing(columnName, column.getEntry(columnName, frame.current(), 1), exposure);
    ...
    if (cloneSelectedDrawingGraphics && selectedNodeIsDrawing) { // Copy graphics from the selected drawing to the created one
        ...
        var drData = Drawing.query.getData({
        ...
        drData.arts.forEach(function(artData) {
